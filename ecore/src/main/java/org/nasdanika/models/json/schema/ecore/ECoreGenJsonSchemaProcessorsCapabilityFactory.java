...
public class ECoreGenJsonSchemaProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenJsonSchemaProcessorsFactory(requirement.requirement().context()))));
	}
