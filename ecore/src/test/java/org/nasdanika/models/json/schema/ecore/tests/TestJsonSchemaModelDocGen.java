package org.nasdanika.models.json.schema.ecore.tests;
...
import org.nasdanika.models.json.schema.ecore.EcoreGenJsonSchemaProcessorsFactory;
 ...
 *
 */
public class TestJsonSchemaModelDocGen {
	
	@Test
	public void testGenerateSemanticContextModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenJsonSchemaProcessorsFactory ecoreGenProcessorFactory = new EcoreGenJsonSchemaProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "json-schema.xmi");
		...
		String siteMapDomain = "https://json-schema.models.nasdanika.org";		
